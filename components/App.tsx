...
const App: React.FC = () => {
  ...
  useEffect(() => {
    // 1. Real-time Subscription (for Supabase)
  ...
  return (
    <div className={clsx(
      ...
      <header className={clsx(
        ...
        >
           {/* Quick Access Safety Guide */}
           <motion.button 
             whileHover={{ scale: 1.05 }}
             whileTap={{ scale: 0.95 }}
             onClick={() => setIsSafetyOpen(true)}
             className={clsx(
               "hidden xl:flex items-center gap-2 px-3 py-1.5 rounded-lg border text-xs font-bold transition-all",
           ...
           {user ? (
             <div className="relative">
                ...
                {isUserMenuOpen && (
                  <motion.div 
                    ...
                    className={clsx(
                      "absolute top-full right-0 mt-2 w-56 border rounded-lg shadow-xl overflow-hidden z-50",
             ...
             <div className="flex items-center gap-2">
                <button onClick={() => setIsSafetyOpen(true)} className="p-2 text-slate-400 hover:text-red-500 transition-colors">
      ...
      <main className="flex-1 relative">
        ...
        {!selectedReport && !loading && (
          <motion.div 
            ...
            className="absolute top-24 left-6 z-40 space-y-2 hidden xl:block"
          >
            <div className={clsx(
              ...
              <div className="space-y-3">
                {['INSAT-3DR', 'Sentinel-2', 'Himawari-9', 'Meteosat-9'].map((sat, i) => (
                  <motion.div 
                    key={sat} 
